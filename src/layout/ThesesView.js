...
const handleAddTopic = (e) => {
    e.preventDefault()
     ...
     document.querySelector("#detai_span").innerHTML = ipName
         const getDasta = async () => {
             await axios.put(
               `http://localhost:8080/thesis/action/putTopic/${TS.id}`, {"topic": ipName}
             );
             const data = await axios.get(
                "http://localhost:8080/thesis"
              );
            ...
            <div className="users_wrapper">
                ...
                <div className="chamdiem">
                    ...
                    <div className="chamdiem_info">
                        ...
                        <span>Đề tài: <span >{tsNOW.topic}</span></span>
                ...
                <div className="edit_users_modal thesis_info">
                    <form>
                        ...
                        <div className="out_box">
                            ...
                            <p onClick={()=> {
                             document.querySelector(".addtopic").classList.add("active")
                            }} className="cancleadd out ">
                                Thêm đề tài
                            </p>
